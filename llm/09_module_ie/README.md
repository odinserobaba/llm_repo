...
## 🎬 Сториборд: путь от текста к IE‑хранилищу

Чтобы увидеть IE как **целый поток**, а не набор разрозненных шагов, можно открыть Excalidraw‑диаграмму:

- сырые тексты → NER (сущности),
- сущности → связи и события,
- промпт‑ориентированный IE на LLM (текст → JSON по схеме),
- хранилище IE: JSON → таблицы / граф,
- связь с RAG/GraphRAG и аналитикой.

Сториборд лежит в файле:

- [[09_module_ie/ie_pipeline_storyboard.excalidraw|Диаграмма IE‑пайплайна (Excalidraw)]]
